...
ImageIcon image=new ImageIcon("Calculatorimage.jpg");
//frame.setIconImage(image.getImage());
    ...
    private void init() {
        ...
        setTitle("MATHEMATICAL CALCULATOR FX 82");
        ...
        btns[16].setBackground(Color.lightGray);
        btns[17].setBackground(Color.lightGray);
        btns[18].setBackground(Color.lightGray);
        btns[19].setBackground(Color.orange);
        ...
        btns[26].setBackground(Color.lightGray);
        btns[27].setBackground(Color.lightGray);
        btns[28].setBackground(Color.lightGray);
        btns[29].setBackground(Color.orange);
        ...
        btns[36].setBackground(Color.lightGray);
        btns[37].setBackground(Color.lightGray);
        btns[38].setBackground(Color.lightGray);
        btns[39].setBackground(Color.orange);
        ...
        btns[46].setBackground(Color.lightGray);
        btns[47].setBackground(Color.lightGray);
        btns[48].setBackground(Color.orange);
